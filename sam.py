...
try:
    # creating the object that stores information about the video
yt = YouTube(url)
...
# Heading label
Label(wn, text="Youtube Video Downloader by ProjectGurukul",
      font=('Courier', 15), fg='grey19').place(x=100, y=15)
...
downloadBtn = Button(wn, text='Download', font=7, fg='grey19',
                     command=downloadVideo).place(x=100, y=350)#hyh
